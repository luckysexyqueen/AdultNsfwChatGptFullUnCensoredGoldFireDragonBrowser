...
// src/model.ts
import { ModelLoadError, GenerationError } from "../core/index.js";
...
function resolveGpuLayers(settings) {
  ...
  if (settings.useWebGPU === true) {
    try {
      const { isWebGPUSupported } = __require("@localmode/core");
...
// src/embedding.ts
import { ModelLoadError as ModelLoadError2, EmbeddingError } from "../core/index.js";
  ...
  async loadModel() {
    ...
    this.loadPromise = (async () => {
      try {
        ...
        this.loadPromise = null;
        if (error instanceof DOMException && error.name === "AbortError") throw error;
        if (error instanceof ModelLoadError2) throw error;
        const cause = error instanceof Error ? error : void 0;
        throw new ModelLoadError2(this.baseModelId, cause);
      }
    })();
    return this.loadPromise;
  }
...
// src/reranker.ts
import { ModelLoadError as ModelLoadError3 } from "../core/index.js";
  ...
  async loadModel() {
    ...
    this.loadPromise = (async () => {
      try {
        ...
        this.loadPromise = null;
        if (error instanceof DOMException && error.name === "AbortError") throw error;
        if (error instanceof ModelLoadError3) throw error;
        const cause = error instanceof Error ? error : void 0;
        throw new ModelLoadError3(this.baseModelId, cause);
      }
    })();
    return this.loadPromise;
  }
